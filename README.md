...
그러므로 sin, cos 함수만으로 구성된 푸리에 급수는 복소 평면에서 구현하는 것이 편리하다.<br/>
...
**응용 분야**<br/>
<br/>
데이터를 분석하여 특정한 값만 추출할 수 있는 그 특성으로 인해 정말 많은 분야에서 활용되고 있다.<br/>
<br/>
1. 음성 신호: 입력된 음성 신호의 잡음에 해당하는 주파수를 추출/제거하여 쾌적한 음향으로 변경하거나, 중폭할 주파수의 영역을 키워 풍부한 음향을 만들 수 있다.
2. 의학: 뇌전도, 심전도 그래프 등의 생체 신호를 분석하고 특정 주파수 대역의 세기를 측정하여 질병의 진단과 치료에 활용할 수 있다.
3. 금융: 주가 그래프와 같은 데이터를 분석하여 시장의 동향을 분석할 수 있다.
<br/>
이를 비롯한 신호 분석 및 처리 분야에서 FFT의 입지는 절대적이라고 할 수 있다.<br/>
